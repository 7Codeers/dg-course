		...
		<>
			<section
				...
				<div className="mt-32 flex">
					<span className="absolute rounded-2xl py-6 right-[285px] top-[405px] px-10 font-vazirmatn text-3xl shadow-md">
						اخبار
					</span>
					...
					<span className="absolute left-[780px] top-[405px] rounded-2xl py-6 px-8 font-vazirmatn text-3xl shadow-md">
						مقالات
					</span>
				...
				<div className="mt-24 mb-56 flex items-center justify-center border rounded-2xl px-28 h-[89px]">
					<span className="font-vazirmatnBold text-2xl text-btn-purple mx-8">
						عضویت در خبرنامه:
					</span>
					<input
